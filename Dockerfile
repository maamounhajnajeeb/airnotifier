...
RUN apt-get update && \
    apt-get install -y --no-install-recommends git ca-certificates build-essential python-dev-is-python3

RUN pip3 install pipenv

RUN git clone https://github.com/maamounhajnajeeb/airnotifier.git /airnotifier
